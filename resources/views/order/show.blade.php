                        ...
                        <div class="card-body">
                                                ...
                                                @if ($od->order_id == $order->id)
                                                    <tr>
                                                        <td>{{ $od->product_name }} <br>
                                                            <form action="{{ route('orderdetail.destroy', $od->id) }}"
                                                                method="POST">
                                                                @method('DELETE')
                                                                @csrf
                            ...
                            <div class="row no-print">
                                <div class="col-12">
                                    ...
                                    <a href="{{ route('print_pdf', $order->id) }}" target="_blank"
                ...
                <div class="modal-body">
                    <form action="{{ route('payments.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="inputName" required autocomplete="off" name="pay"
                                class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Date</label>
